...
const MovieDetailsPage: FC<MovieDetailsPageProps> = ({ }) => {
    ...
    return (
        <section className="w-[60%] min-w-[500px] min-h-fit max-h-[80%] rounded-xl p-10 bg flex flex-col items-center justify-around gap-5 lg:flex-row  z-20 bg-zinc-800  absolute shadow-xl overflow-y-auto">
            {movie &&
                <>
